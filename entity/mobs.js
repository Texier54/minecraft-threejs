...
const textures = {
    pig_head_front: loadTexture('images/entity/mob/pig/pig_head_front.png'),
    pig_head_right: loadTexture('images/entity/mob/pig/pig_head_right.png'),
    pig_head_left: loadTexture('images/entity/mob/pig/pig_head_left.png'),
    pig_head_top: loadTexture('images/entity/mob/pig/pig_head_top.png'),
    pig_feet: loadTexture('images/entity/mob/pig/pig_feet_side.png'),
    pig_body_back: loadTexture('images/entity/mob/pig/pig_body_back.png'),
    pig_body_side: loadTexture('images/entity/mob/pig/pig_body_side.png'),
    pig_body_right: loadTexture('images/entity/mob/pig/pig_body_right.png'),
    pig_noise_front: loadTexture('images/entity/mob/pig/pig_noise_front.png'),
    steve_head_front: loadTexture('images/entity/player/steve_head_front.png'),
    steve_head_back: loadTexture('images/entity/player/steve_head_back.png'),
    steve_head_right: loadTexture('images/entity/player/steve_head_right.png'),
    steve_head_left: loadTexture('images/entity/player/steve_head_left.png'),
    steve_head_top: loadTexture('images/entity/player/steve_head_top.png'),
    steve_head_bottom: loadTexture('images/entity/player/steve_head_bottom.png'),
    steve_body_top: loadTexture('images/entity/player/steve_body_top.png'),
    steve_body_front: loadTexture('images/entity/player/steve_body_front.png'),
    steve_body_back: loadTexture('images/entity/player/steve_body_back.png'),
    steve_body_right: loadTexture('images/entity/player/steve_body_right.png'),
    steve_body_left: loadTexture('images/entity/player/steve_body_left.png'),
    steve_arm_top: loadTexture('images/entity/player/steve_arm_top.png'),
    steve_arm_bottom: loadTexture('images/entity/player/steve_arm_bottom.png'),
    steve_arm_front: loadTexture('images/entity/player/steve_arm_front.png'),
    steve_arm_right: loadTexture('images/entity/player/steve_arm_right.png'),
    steve_arm_left: loadTexture('images/entity/player/steve_arm_left.png'),
    steve_arm_back: loadTexture('images/entity/player/steve_arm_back.png'),
    steve_leg_front: loadTexture('images/entity/player/steve_leg_front.png'),
    steve_leg_back: loadTexture('images/entity/player/steve_leg_back.png'),
    steve_leg_right: loadTexture('images/entity/player/steve_leg_right.png'),
    steve_leg_left: loadTexture('images/entity/player/steve_leg_left.png'),
    cow_head_front: loadTexture('images/entity/mob/cow/cow_head_front.png'),
    cow_head_top: loadTexture('images/entity/mob/cow/cow_head_top.png'),
    cow_head_left: loadTexture('images/entity/mob/cow/cow_head_left.png'),
    cow_head_right: loadTexture('images/entity/mob/cow/cow_head_right.png'),
    cow_body_left: loadTexture('images/entity/mob/cow/cow_body_left.png'),
    cow_body_right: loadTexture('images/entity/mob/cow/cow_body_right.png'),
    cow_body_top: loadTexture('images/entity/mob/cow/cow_body_top.png'),
    cow_body_bottom: loadTexture('images/entity/mob/cow/cow_body_bottom.png'),
};
