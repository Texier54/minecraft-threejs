var Ta=Object.defineProperty;var dr=t=>{throw TypeError(t)};var xa=(t,n,e)=>n in t?Ta(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var xe=(t,n,e)=>xa(t,typeof n!="symbol"?n+"":n,e),ba=(t,n,e)=>n.has(t)||dr("Cannot "+e);var Hn=(t,n,e)=>(ba(t,n,"read from private field"),e?e.call(t):n.get(t)),fr=(t,n,e)=>n.has(t)?dr("Cannot add the same private member more than once"):n instanceof WeakSet?n.add(t):n.set(t,e);import{c as Aa,S as Ki,N as Xt,C as je,F as Ao,V as Ce,R as ya,W as _n,H as ai,U as tn,L as bn,a as st,D as Gt,B as Ct,b as wn,t as Ra,d as Ca,p as wa,w as dn,e as Pa,E as La,f as _t,P as Rn,g as Mt,A as Da,h as Vt,i as ni,j as $i,k as Pn,l as Ln,m as yo,n as Ia,M as Nt,o as si,q as Ua,r as Ve,s as Na,u as Oa,v as Fa,x as nn,y as Ro,z as $n,G as Je,I as Co,J as en,K as Ht,O as It,Q as ii,T as Tn,X as Ba,Y as ka,Z as Ha,_ as Ga,$ as Va,a0 as za,a1 as Wa,a2 as Xa,a3 as qa,a4 as Ya,a5 as Ka,a6 as $a,a7 as Za,a8 as ja,a9 as Ja,aa as Qa,ab as es,ac as ts,ad as ns,ae as is,af as rs,ag as Gn,ah as hn,ai as pi,aj as os,ak as as,al as ss,am as wo,an as cs,ao as ls,ap as ds,aq as fs,ar as zt,as as Po,at as Lo,au as Do,av as ri,aw as Io,ax as Uo,ay as ci,az as pt,aA as ur,aB as Ze,aC as No,aD as Oo,aE as Fo,aF as Qt,aG as Di,aH as Ii,aI as us,aJ as Bo,aK as hs,aL as ps,aM as Zn,aN as ms,aO as _s,aP as hr,aQ as pr,aR as mr,aS as gs,aT as _r,aU as vs,aV as fn,aW as gr,aX as Es,aY as Ss,aZ as Ms,a_ as Ts,a$ as xs,b0 as bs,b1 as As,b2 as ys,b3 as Rs,b4 as mi,b5 as _i,b6 as gi,b7 as vi,b8 as vr,b9 as Er,ba as Sr,bb as Mr,bc as Tr,bd as xr,be as br,bf as Ar,bg as yr,bh as Rr,bi as Cr,bj as wr,bk as Pr,bl as Lr,bm as Dr,bn as Ir,bo as Ur,bp as Nr,bq as Or,br as Fr,bs as Br,bt as Ei,bu as kr,bv as Hr,bw as Cs,bx as Gr,by as Vr,bz as zr,bA as ko,bB as Et,bC as Dn,bD as In,bE as gn,bF as Wt,bG as ws,bH as Ps,bI as Ls,bJ as Wr,bK as Ds,bL as Ui,bM as Ni,bN as Oi,bO as Fi,bP as Bi,bQ as ki,bR as Hi,bS as Is,bT as Us,bU as Ho,bV as Ns,bW as Os,bX as Fs,bY as Bs,bZ as ks,b_ as Hs,b$ as Gs,c0 as Vs,c1 as Go,c2 as zs,c3 as Ws,c4 as Xs,c5 as qs,c6 as Ys,c7 as Ks,c8 as $s,c9 as Zs,ca as oi,cb as $e,cc as js,cd as ht,ce as Js,cf as pe,cg as Qs,ch as ec,ci as tc,cj as nc,ck as ic,cl as rc,cm as oc,cn as ac,co as sc,cp as cc,cq as lc}from"./recipes-DZrZy5gB.js";/**
 * @license
...
#define LOW_PRECISION`),n}function uu(t){let n="SHADOWMAP_TYPE_BASIC";return t.shadowMapType===Co?n="SHADOWMAP_TYPE_PCF":t.shadowMapType===Go?n="SHADOWMAP_TYPE_PCF_SOFT":t.shadowMapType===Ht&&(n="SHADOWMAP_TYPE_VSM"),n}function hu(t){let n="ENVMAP_TYPE_CUBE";if(t.envMap)switch(t.envMapMode){case In:case gn:n="ENVMAP_TYPE_CUBE";break;case ci:n="ENVMAP_TYPE_CUBE_UV";break}return n}function pu(t){let n="ENVMAP_MODE_REFLECTION";if(t.envMap)switch(t.envMapMode){case gn:n="ENVMAP_MODE_REFRACTION";break}return n}function mu(t){let n="ENVMAP_BLENDING_NONE";if(t.envMap)switch(t.combine){case Ks:n="ENVMAP_BLENDING_MULTIPLY";break;case Ys:n="ENVMAP_BLENDING_MIX";break;case qs:n="ENVMAP_BLENDING_ADD";break}return n}function _u(t){const n=t.envMapCubeUVHeight;if(n===null)return null;const e=Math.log2(n)-2,i=1/n;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function gu(t,n,e,i){const r=t.getContext(),o=e.defines;let a=e.vertexShader,s=e.fragmentShader;const p=uu(e),m=hu(e),g=pu(e),v=mu(e),E=_u(e),M=ru(e),D=ou(o),C=r.createProgram();let f,c,I=e.glslVersion?"#version "+e.glslVersion+`
