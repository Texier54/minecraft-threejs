...
`)}const Uo=new Ue;function np(i){Ke._getMatrix(Uo,Ke.workingColorSpace,i);const e=`mat3( ${Uo.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case Rr:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Io(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=i.getShaderInfoLog(e).trim();if(n&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`
...
}`;class Vp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new St,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!==n.depthNear||t.depthFar!==n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new wn({vertexShader:Gp,fragmentShader:Hp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Jt(new Ir(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Wp extends qn{constructor(e,t){super();const n=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,d=null,f=null,p=null,_=null;const M=new Vp,m=t.getContextAttributes();let h=null,T=null;const b=[],y=[],I=new Be;let A=null;const R=new Vt;R.viewport=new it;const N=new Vt;N.viewport=new it;const S=[R,N],x=new uu;let C=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Y){let ie=b[Y];return ie===void 0&&(ie=new _s,b[Y]=ie),ie.getTargetRaySpace()},this.getControllerGrip=function(Y){let ie=b[Y];return ie===void 0&&(ie=new _s,b[Y]=ie),ie.getGripSpace()},this.getHand=function(Y){let ie=b[Y];return ie===void 0&&(ie=new _s,b[Y]=ie),ie.getHandSpace()};function z(Y){const ie=y.indexOf(Y.inputSource);if(ie===-1)return;const ve=b[ie];ve!==void 0&&(ve.update(Y.inputSource,Y.frame,c||o),ve.dispatchEvent({type:Y.type,data:Y.inputSource}))}function W(){r.removeEventListener("select",z),r.removeEventListener("selectstart",z),r.removeEventListener("selectend",z),r.removeEventListener("squeeze",z),r.removeEventListener("squeezestart",z),r.removeEventListener("squeezeend",z),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",$);for(let Y=0;Y<b.length;Y++){const ie=y[Y];ie!==null&&(y[Y]=null,b[Y].disconnect(ie))}C=null,G=null,M.reset(),e.setRenderTarget(h),p=null,f=null,d=null,r=null,T=null,rt.stop(),n.isPresenting=!1,e.setPixelRatio(A),e.setSize(I.width,I.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Y){s=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Y){a=Y,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(Y){c=Y},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Y){if(r=Y,r!==null){if(h=e.getRenderTarget(),r.addEventListener("select",z),r.addEventListener("selectstart",z),r.addEventListener("selectend",z),r.addEventListener("squeeze",z),r.addEventListener("squeezestart",z),r.addEventListener("squeezeend",z),r.addEventListener("end",W),r.addEventListener("inputsourceschange",$),m.xrCompatible!==!0&&await t.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(I),r.enabledFeatures!==void 0&&r.enabledFeatures.includes("layers")){let ve=null,le=null,Ae=null;m.depth&&(Ae=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ve=m.stencil?Ei:_i,le=m.stencil?yi:Wn);const Ce={colorFormat:t.RGBA8,depthFormat:Ae,scaleFactor:s};d=new XRWebGLBinding(r,t),f=d.createProjectionLayer(Ce),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),T=new Xn(f.textureWidth,f.textureHeight,{format:jt,type:mn,depthTexture:new ml(f.textureWidth,f.textureHeight,le,void 0,void 0,void 0,void 0,void 0,void 0,ve),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}else{const ve={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,ve),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),T=new Xn(p.framebufferWidth,p.framebufferHeight,{format:jt,type:mn,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}T.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),rt.setContext(r),rt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function $(Y){for(let ie=0;ie<Y.removed.length;ie++){const ve=Y.removed[ie],le=y.indexOf(ve);le>=0&&(y[le]=null,b[le].disconnect(ve))}for(let ie=0;ie<Y.added.length;ie++){const ve=Y.added[ie];let le=y.indexOf(ve);if(le===-1){for(let Ce=0;Ce<b.length;Ce++)if(Ce>=y.length){y.push(ve),le=Ce;break}else if(y[Ce]===null){y[Ce]=ve,le=Ce;break}if(le===-1)break}const Ae=b[le];Ae&&Ae.connect(ve)}}const X=new U,te=new U;function V(Y,ie,ve){X.setFromMatrixPosition(ie.matrixWorld),te.setFromMatrixPosition(ve.matrixWorld);const le=X.distanceTo(te),Ae=ie.projectionMatrix.elements,Ce=ve.projectionMatrix.elements,ze=Ae[14]/(Ae[10]-1),lt=Ae[14]/(Ae[10]+1),Xe=(Ae[9]+1)/Ae[5],dt=(Ae[9]-1)/Ae[5],w=(Ae[8]-1)/Ae[0],kt=(Ce[8]+1)/Ce[0],He=ze*w,Ve=ze*kt,ye=le/(-w+kt),at=ye*-w;if(ie.matrixWorld.decompose(Y.position,Y.quaternion,Y.scale),Y.translateX(at),Y.translateZ(ye),Y.matrixWorld.compose(Y.position,Y.quaternion,Y.scale),Y.matrixWorldInverse.copy(Y.matrixWorld).invert(),Ae[10]===-1)Y.projectionMatrix.copy(ie.projectionMatrix),Y.projectionMatrixInverse.copy(ie.projectionMatrixInverse);else{const Me=ze+ye,E=lt+ye,g=He-at,O=Ve+(le-at),Z=Xe*lt/E*Me,j=dt*lt/E*Me;Y.projectionMatrix.makePerspective(g,O,Z,j,Me,E),Y.projectionMatrixInverse.copy(Y.projectionMatrix).invert()}}function oe(Y,ie){ie===null?Y.matrixWorld.copy(Y.matrix):Y.matrixWorld.multiplyMatrices(ie.matrixWorld,Y.matrix),Y.matrixWorldInverse.copy(Y.matrixWorld).invert()}this.updateCamera=function(Y){if(r===null)return;let ie=Y.near,ve=Y.far;M.texture!==null&&(M.depthNear>0&&(ie=M.depthNear),M.depthFar>0&&(ve=M.depthFar)),x.near=N.near=R.near=ie,x.far=N.far=R.far=ve,(C!==x.near||G!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),C=x.near,G=x.far),R.layers.mask=Y.layers.mask|2,N.layers.mask=Y.layers.mask|4,x.layers.mask=R.layers.mask|N.layers.mask;const le=Y.parent,Ae=x.cameras;oe(x,le);for(let Ce=0;Ce<Ae.length;Ce++)oe(Ae[Ce],le);Ae.length===2?V(x,R,N):x.projectionMatrix.copy(R.projectionMatrix),fe(Y,x,le)};function fe(Y,ie,ve){ve===null?Y.matrix.copy(ie.matrixWorld):(Y.matrix.copy(ve.matrixWorld),Y.matrix.invert(),Y.matrix.multiply(ie.matrixWorld)),Y.matrix.decompose(Y.position,Y.quaternion,Y.scale),Y.updateMatrixWorld(!0),Y.projectionMatrix.copy(ie.projectionMatrix),Y.projectionMatrixInverse.copy(ie.projectionMatrixInverse),Y.isPerspectiveCamera&&(Y.fov=ra*2*Math.atan(1/Y.projectionMatrix.elements[5]),Y.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(Y){l=Y,f!==null&&(f.fixedFoveation=Y),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Y)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(x)};let Se=null;function ke(Y,ie){if(u=ie.getViewerPose(c||o),_=ie,u!==null){const ve=u.views;p!==null&&(e.setRenderTargetFramebuffer(T,p.framebuffer),e.setRenderTarget(T));let le=!1;ve.length!==x.cameras.length&&(x.cameras.length=0,le=!0);for(let Ce=0;Ce<ve.length;Ce++){const ze=ve[Ce];let lt=null;if(p!==null)lt=p.getViewport(ze);else{const dt=d.getViewSubImage(f,ze);lt=dt.viewport,Ce===0&&(e.setRenderTargetTextures(T,dt.colorTexture,f.ignoreDepthValues?void 0:dt.depthStencilTexture),e.setRenderTarget(T))}let Xe=S[Ce];Xe===void 0&&(Xe=new Vt,Xe.layers.enable(Ce),Xe.viewport=new it,S[Ce]=Xe),Xe.matrix.fromArray(ze.transform.matrix),Xe.matrix.decompose(Xe.position,Xe.quaternion,Xe.scale),Xe.projectionMatrix.fromArray(ze.projectionMatrix),Xe.projectionMatrixInverse.copy(Xe.projectionMatrix).invert(),Xe.viewport.set(lt.x,lt.y,lt.width,lt.height),Ce===0&&(x.matrix.copy(Xe.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),le===!0&&x.cameras.push(Xe)}const Ae=r.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")){const Ce=d.getDepthInformation(ve[0]);Ce&&Ce.isValid&&Ce.texture&&M.init(e,Ce,r.renderState)}}for(let ve=0;ve<b.length;ve++){const le=y[ve],Ae=b[ve];le!==null&&Ae!==void 0&&Ae.update(le,ie,c||o)}Se&&Se(Y,ie),ie.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ie}),_=null}const rt=new Ml;rt.setAnimationLoop(ke),this.setAnimationLoop=function(Y){Se=Y},this.dispose=function(){}}}const Fn=new Qt,Xp=new et;function qp(i,e){function t(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function n(m,h){h.color.getRGB(m.fogColor.value,ul(i)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function r(m,h,T,b,y){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(m,h):h.isMeshToonMaterial?(s(m,h),d(m,h)):h.isMeshPhongMaterial?(s(m,h),u(m,h)):h.isMeshStandardMaterial?(s(m,h),f(m,h),h.isMeshPhysicalMaterial&&p(m,h,y)):h.isMeshMatcapMaterial?(s(m,h),_(m,h)):h.isMeshDepthMaterial?s(m,h):h.isMeshDistanceMaterial?(s(m,h),M(m,h)):h.isMeshNormalMaterial?s(m,h):h.isLineBasicMaterial?(o(m,h),h.isLineDashedMaterial&&a(m,h)):h.isPointsMaterial?l(m,h,T,b):h.isSpriteMaterial?c(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,t(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===Lt&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,t(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===Lt&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,t(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,t(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);const T=e.get(h),b=T.envMap,y=T.envMapRotation;b&&(m.envMap.value=b,Fn.copy(y),Fn.x*=-1,Fn.y*=-1,Fn.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Fn.y*=-1,Fn.z*=-1),m.envMapRotation.value.setFromMatrix4(Xp.makeRotationFromEuler(Fn)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,m.aoMapTransform))}function o(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform))}function a(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,T,b){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*T,m.scale.value=b*.5,h.map&&(m.map.value=h.map,t(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function c(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function u(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function d(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function f(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function p(m,h,T){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Lt&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=T.texture,m.transmissionSamplerSize.value.set(T.width,T.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,h){h.matcap&&(m.matcap.value=h.matcap)}function M(m,h){const T=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(T.matrixWorld),m.nearDistance.value=T.shadow.camera.near,m.farDistance.value=T.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Yp(i,e,t,n){let r={},s={},o=[];const a=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function l(T,b){const y=b.program;n.uniformBlockBinding(T,y)}function c(T,b){let y=r[T.id];y===void 0&&(_(T),y=u(T),r[T.id]=y,T.addEventListener("dispose",m));const I=b.program;n.updateUBOMapping(T,I);const A=e.render.frame;s[T.id]!==A&&(f(T),s[T.id]=A)}function u(T){const b=d();T.__bindingPointIndex=b;const y=i.createBuffer(),I=T.__size,A=T.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,I,A),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,b,y),y}function d(){for(let T=0;T<a;T++)if(o.indexOf(T)===-1)return o.push(T),T;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(T){const b=r[T.id],y=T.uniforms,I=T.__cache;i.bindBuffer(i.UNIFORM_BUFFER,b);for(let A=0,R=y.length;A<R;A++){const N=Array.isArray(y[A])?y[A]:[y[A]];for(let S=0,x=N.length;S<x;S++){const C=N[S];if(p(C,A,S,I)===!0){const G=C.__offset,z=Array.isArray(C.value)?C.value:[C.value];let W=0;for(let $=0;$<z.length;$++){const X=z[$],te=M(X);typeof X=="number"||typeof X=="boolean"?(C.__data[0]=X,i.bufferSubData(i.UNIFORM_BUFFER,G+W,C.__data)):X.isMatrix3?(C.__data[0]=X.elements[0],C.__data[1]=X.elements[1],C.__data[2]=X.elements[2],C.__data[3]=0,C.__data[4]=X.elements[3],C.__data[5]=X.elements[4],C.__data[6]=X.elements[5],C.__data[7]=0,C.__data[8]=X.elements[6],C.__data[9]=X.elements[7],C.__data[10]=X.elements[8],C.__data[11]=0):(X.toArray(C.__data,W),W+=te.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,G,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(T,b,y,I){const A=T.value,R=b+"_"+y;if(I[R]===void 0)return typeof A=="number"||typeof A=="boolean"?I[R]=A:I[R]=A.clone(),!0;{const N=I[R];if(typeof A=="number"||typeof A=="boolean"){if(N!==A)return I[R]=A,!0}else if(N.equals(A)===!1)return N.copy(A),!0}return!1}function _(T){const b=T.uniforms;let y=0;const I=16;for(let R=0,N=b.length;R<N;R++){const S=Array.isArray(b[R])?b[R]:[b[R]];for(let x=0,C=S.length;x<C;x++){const G=S[x],z=Array.isArray(G.value)?G.value:[G.value];for(let W=0,$=z.length;W<$;W++){const X=z[W],te=M(X),V=y%I,oe=V%te.boundary,fe=V+oe;y+=oe,fe!==0&&I-fe<te.storage&&(y+=I-fe),G.__data=new Float32Array(te.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=y,y+=te.storage}}}const A=y%I;return A>0&&(y+=I-A),T.__size=y,T.__cache={},this}function M(T){const b={boundary:0,storage:0};return typeof T=="number"||typeof T=="boolean"?(b.boundary=4,b.storage=4):T.isVector2?(b.boundary=8,b.storage=8):T.isVector3||T.isColor?(b.boundary=16,b.storage=12):T.isVector4?(b.boundary=16,b.storage=16):T.isMatrix3?(b.boundary=48,b.storage=48):T.isMatrix4?(b.boundary=64,b.storage=64):T.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",T),b}function m(T){const b=T.target;b.removeEventListener("dispose",m);const y=o.indexOf(b.__bindingPointIndex);o.splice(y,1),i.deleteBuffer(r[b.id]),delete r[b.id],delete s[b.id]}function h(){for(const T in r)i.deleteBuffer(r[T]);o=[],r={},s={}}return{bind:l,update:c,dispose:h}}class fm{constructor(e={}){const{canvas:t=yc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:d=!1,reverseDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=o;const _=new Uint32Array(4),M=new Int32Array(4);let m=null,h=null;const T=[],b=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ft,this.toneMapping=bn,this.toneMappingExposure=1;const y=this;let I=!1,A=0,R=0,N=null,S=-1,x=null;const C=new it,G=new it;let z=null;const W=new Ie(0);let $=0,X=t.width,te=t.height,V=1,oe=null,fe=null;const Se=new it(0,0,X,te),ke=new it(0,0,X,te);let rt=!1;const Y=new Ma;let ie=!1,ve=!1;this.transmissionResolutionScale=1;const le=new et,Ae=new et,Ce=new U,ze=new it,lt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Xe=!1;function dt(){return N===null?V:1}let w=n;function kt(v,L){return t.getContext(v,L)}try{const v={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${oa}`),t.addEventListener("webglcontextlost",K,!1),t.addEventListener("webglcontextrestored",he,!1),t.addEventListener("webglcontextcreationerror",ue,!1),w===null){const L="webgl2";if(w=kt(L,v),w===null)throw kt(L)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(v){throw console.error("THREE.WebGLRenderer: "+v.message),v}let He,Ve,ye,at,Me,E,g,O,Z,j,q,xe,ce,pe,qe,Q,me,Te,we,ge,We,Ne,st,P;function se(){He=new nf(w),He.init(),Ne=new kp(w,He),Ve=new $d(w,He,e,Ne),ye=new Op(w,He),Ve.reverseDepthBuffer&&f&&ye.buffers.depth.setReversed(!0),at=new af(w),Me=new bp,E=new Bp(w,He,ye,Me,Ve,Ne,at),g=new Jd(y),O=new tf(y),Z=new du(w),st=new Zd(w,Z),j=new rf(w,Z,at,st),q=new lf(w,j,Z,at),we=new of(w,Ve,E),Q=new jd(Me),xe=new Ep(y,g,O,He,Ve,st,Q),ce=new qp(y,Me),pe=new Ap,qe=new Dp(He),Te=new Yd(y,g,O,ye,q,p,l),me=new Np(y,q,Ve),P=new Yp(w,at,Ve,ye),ge=new Kd(w,He,at),We=new sf(w,He,at),at.programs=xe.programs,y.capabilities=Ve,y.extensions=He,y.properties=Me,y.renderLists=pe,y.shadowMap=me,y.state=ye,y.info=at}se();const H=new Wp(y,w);this.xr=H,this.getContext=function(){return w},this.getContextAttributes=function(){return w.getContextAttributes()},this.forceContextLoss=function(){const v=He.get("WEBGL_lose_context");v&&v.loseContext()},this.forceContextRestore=function(){const v=He.get("WEBGL_lose_context");v&&v.restoreContext()},this.getPixelRatio=function(){return V},this.setPixelRatio=function(v){v!==void 0&&(V=v,this.setSize(X,te,!1))},this.getSize=function(v){return v.set(X,te)},this.setSize=function(v,L,B=!0){if(H.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=v,te=L,t.width=Math.floor(v*V),t.height=Math.floor(L*V),B===!0&&(t.style.width=v+"px",t.style.height=L+"px"),this.setViewport(0,0,v,L)},this.getDrawingBufferSize=function(v){return v.set(X*V,te*V).floor()},this.setDrawingBufferSize=function(v,L,B){X=v,te=L,V=B,t.width=Math.floor(v*B),t.height=Math.floor(L*B),this.setViewport(0,0,v,L)},this.getCurrentViewport=function(v){return v.copy(C)},this.getViewport=function(v){return v.copy(Se)},this.setViewport=function(v,L,B,k){v.isVector4?Se.set(v.x,v.y,v.z,v.w):Se.set(v,L,B,k),ye.viewport(C.copy(Se).multiplyScalar(V).round())},this.getScissor=function(v){return v.copy(ke)},this.setScissor=function(v,L,B,k){v.isVector4?ke.set(v.x,v.y,v.z,v.w):ke.set(v,L,B,k),ye.scissor(G.copy(ke).multiplyScalar(V).round())},this.getScissorTest=function(){return rt},this.setScissorTest=function(v){ye.setScissorTest(rt=v)},this.setOpaqueSort=function(v){oe=v},this.setTransparentSort=function(v){fe=v},this.getClearColor=function(v){return v.copy(Te.getClearColor())},this.setClearColor=function(){Te.setClearColor.apply(Te,arguments)},this.getClearAlpha=function(){return Te.getClearAlpha()},this.setClearAlpha=function(){Te.setClearAlpha.apply(Te,arguments)},this.clear=function(v=!0,L=!0,B=!0){let k=0;if(v){let D=!1;if(N!==null){const J=N.texture.format;D=J===ma||J===pa||J===fa}if(D){const J=N.texture.type,ae=J===mn||J===Wn||J===Gi||J===yi||J===ua||J===ha,de=Te.getClearColor(),_e=Te.getClearAlpha(),Re=de.r,Pe=de.g,Ee=de.b;ae?(_[0]=Re,_[1]=Pe,_[2]=Ee,_[3]=_e,w.clearBufferuiv(w.COLOR,0,_)):(M[0]=Re,M[1]=Pe,M[2]=Ee,M[3]=_e,w.clearBufferiv(w.COLOR,0,M))}else k|=w.COLOR_BUFFER_BIT}L&&(k|=w.DEPTH_BUFFER_BIT),B&&(k|=w.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),w.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",K,!1),t.removeEventListener("webglcontextrestored",he,!1),t.removeEventListener("webglcontextcreationerror",ue,!1),Te.dispose(),pe.dispose(),qe.dispose(),Me.dispose(),g.dispose(),O.dispose(),q.dispose(),st.dispose(),P.dispose(),xe.dispose(),H.dispose(),H.removeEventListener("sessionstart",ba),H.removeEventListener("sessionend",Ta),Cn.stop()};function K(v){v.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),I=!0}function he(){console.log("THREE.WebGLRenderer: Context Restored."),I=!1;const v=at.autoReset,L=me.enabled,B=me.autoUpdate,k=me.needsUpdate,D=me.type;se(),at.autoReset=v,me.enabled=L,me.autoUpdate=B,me.needsUpdate=k,me.type=D}function ue(v){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",v.statusMessage)}function De(v){const L=v.target;L.removeEventListener("dispose",De),ct(L)}function ct(v){Et(v),Me.remove(v)}function Et(v){const L=Me.get(v).programs;L!==void 0&&(L.forEach(function(B){xe.releaseProgram(B)}),v.isShaderMaterial&&xe.releaseShaderCache(v))}this.renderBufferDirect=function(v,L,B,k,D,J){L===null&&(L=lt);const ae=D.isMesh&&D.matrixWorld.determinant()<0,de=wl(v,L,B,k,D);ye.setMaterial(k,ae);let _e=B.index,Re=1;if(k.wireframe===!0){if(_e=j.getWireframeAttribute(B),_e===void 0)return;Re=2}const Pe=B.drawRange,Ee=B.attributes.position;let Ye=Pe.start*Re,$e=(Pe.start+Pe.count)*Re;J!==null&&(Ye=Math.max(Ye,J.start*Re),$e=Math.min($e,(J.start+J.count)*Re)),_e!==null?(Ye=Math.max(Ye,0),$e=Math.min($e,_e.count)):Ee!=null&&(Ye=Math.max(Ye,0),$e=Math.min($e,Ee.count));const pt=$e-Ye;if(pt<0||pt===1/0)return;st.setup(D,k,de,B,_e);let ut,Ze=ge;if(_e!==null&&(ut=Z.get(_e),Ze=We,Ze.setIndex(ut)),D.isMesh)k.wireframe===!0?(ye.setLineWidth(k.wireframeLinewidth*dt()),Ze.setMode(w.LINES)):Ze.setMode(w.TRIANGLES);else if(D.isLine){let be=k.linewidth;be===void 0&&(be=1),ye.setLineWidth(be*dt()),D.isLineSegments?Ze.setMode(w.LINES):D.isLineLoop?Ze.setMode(w.LINE_LOOP):Ze.setMode(w.LINE_STRIP)}else D.isPoints?Ze.setMode(w.POINTS):D.isSprite&&Ze.setMode(w.TRIANGLES);if(D.isBatchedMesh)if(D._multiDrawInstances!==null)Ze.renderMultiDrawInstances(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount,D._multiDrawInstances);else if(He.get("WEBGL_multi_draw"))Ze.renderMultiDraw(D._multiDrawStarts,D._multiDrawCounts,D._multiDrawCount);else{const be=D._multiDrawStarts,Mt=D._multiDrawCounts,je=D._multiDrawCount,Yt=_e?Z.get(_e).bytesPerElement:1,Zn=Me.get(k).currentProgram.getUniforms();for(let Ut=0;Ut<je;Ut++)Zn.setValue(w,"_gl_DrawID",Ut),Ze.render(be[Ut]/Yt,Mt[Ut])}else if(D.isInstancedMesh)Ze.renderInstances(Ye,pt,D.count);else if(B.isInstancedBufferGeometry){const be=B._maxInstanceCount!==void 0?B._maxInstanceCount:1/0,Mt=Math.min(B.instanceCount,be);Ze.renderInstances(Ye,pt,Mt)}else Ze.render(Ye,pt)};function Je(v,L,B){v.transparent===!0&&v.side===Wt&&v.forceSinglePass===!1?(v.side=Lt,v.needsUpdate=!0,qi(v,L,B),v.side=An,v.needsUpdate=!0,qi(v,L,B),v.side=Wt):qi(v,L,B)}this.compile=function(v,L,B=null){B===null&&(B=v),h=qe.get(B),h.init(L),b.push(h),B.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),v!==B&&v.traverseVisible(function(D){D.isLight&&D.layers.test(L.layers)&&(h.pushLight(D),D.castShadow&&h.pushShadow(D))}),h.setupLights();const k=new Set;return v.traverse(function(D){if(!(D.isMesh||D.isPoints||D.isLine||D.isSprite))return;const J=D.material;if(J)if(Array.isArray(J))for(let ae=0;ae<J.length;ae++){const de=J[ae];Je(de,B,D),k.add(de)}else Je(J,B,D),k.add(J)}),b.pop(),h=null,k},this.compileAsync=function(v,L,B=null){const k=this.compile(v,L,B);return new Promise(D=>{function J(){if(k.forEach(function(ae){Me.get(ae).currentProgram.isReady()&&k.delete(ae)}),k.size===0){D(v);return}setTimeout(J,10)}He.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let qt=null;function on(v){qt&&qt(v)}function ba(){Cn.stop()}function Ta(){Cn.start()}const Cn=new Ml;Cn.setAnimationLoop(on),typeof self<"u"&&Cn.setContext(self),this.setAnimationLoop=function(v){qt=v,H.setAnimationLoop(v),v===null?Cn.stop():Cn.start()},H.addEventListener("sessionstart",ba),H.addEventListener("sessionend",Ta),this.render=function(v,L){if(L!==void 0&&L.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(I===!0)return;if(v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),L.parent===null&&L.matrixWorldAutoUpdate===!0&&L.updateMatrixWorld(),H.enabled===!0&&H.isPresenting===!0&&(H.cameraAutoUpdate===!0&&H.updateCamera(L),L=H.getCamera()),v.isScene===!0&&v.onBeforeRender(y,v,L,N),h=qe.get(v,b.length),h.init(L),b.push(h),Ae.multiplyMatrices(L.projectionMatrix,L.matrixWorldInverse),Y.setFromProjectionMatrix(Ae),ve=this.localClippingEnabled,ie=Q.init(this.clippingPlanes,ve),m=pe.get(v,T.length),m.init(),T.push(m),H.enabled===!0&&H.isPresenting===!0){const J=y.xr.getDepthSensingMesh();J!==null&&Fr(J,L,-1/0,y.sortObjects)}Fr(v,L,0,y.sortObjects),m.finish(),y.sortObjects===!0&&m.sort(oe,fe),Xe=H.enabled===!1||H.isPresenting===!1||H.hasDepthSensing()===!1,Xe&&Te.addToRenderList(m,v),this.info.render.frame++,ie===!0&&Q.beginShadows();const B=h.state.shadowsArray;me.render(B,v,L),ie===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=m.opaque,D=m.transmissive;if(h.setupLights(),L.isArrayCamera){const J=L.cameras;if(D.length>0)for(let ae=0,de=J.length;ae<de;ae++){const _e=J[ae];wa(k,D,v,_e)}Xe&&Te.render(v);for(let ae=0,de=J.length;ae<de;ae++){const _e=J[ae];Aa(m,v,_e,_e.viewport)}}else D.length>0&&wa(k,D,v,L),Xe&&Te.render(v),Aa(m,v,L);N!==null&&R===0&&(E.updateMultisampleRenderTarget(N),E.updateRenderTargetMipmap(N)),v.isScene===!0&&v.onAfterRender(y,v,L),st.resetDefaultState(),S=-1,x=null,b.pop(),b.length>0?(h=b[b.length-1],ie===!0&&Q.setGlobalState(y.clippingPlanes,h.state.camera)):h=null,T.pop(),T.length>0?m=T[T.length-1]:m=null};function Fr(v,L,B,k){if(v.visible===!1)return;if(v.layers.test(L.layers)){if(v.isGroup)B=v.renderOrder;else if(v.isLOD)v.autoUpdate===!0&&v.update(L);else if(v.isLight)h.pushLight(v),v.castShadow&&h.pushShadow(v);else if(v.isSprite){if(!v.frustumCulled||Y.intersectsSprite(v)){k&&ze.setFromMatrixPosition(v.matrixWorld).applyMatrix4(Ae);const ae=q.update(v),de=v.material;de.visible&&m.push(v,ae,de,B,ze.z,null)}}else if((v.isMesh||v.isLine||v.isPoints)&&(!v.frustumCulled||Y.intersectsObject(v))){const ae=q.update(v),de=v.material;if(k&&(v.boundingSphere!==void 0?(v.boundingSphere===null&&v.computeBoundingSphere(),ze.copy(v.boundingSphere.center)):(ae.boundingSphere===null&&ae.computeBoundingSphere(),ze.copy(ae.boundingSphere.center)),ze.applyMatrix4(v.matrixWorld).applyMatrix4(Ae)),Array.isArray(de)){const _e=ae.groups;for(let Re=0,Pe=_e.length;Re<Pe;Re++){const Ee=_e[Re],Ye=de[Ee.materialIndex];Ye&&Ye.visible&&m.push(v,ae,Ye,B,ze.z,Ee)}}else de.visible&&m.push(v,ae,de,B,ze.z,null)}}const J=v.children;for(let ae=0,de=J.length;ae<de;ae++)Fr(J[ae],L,B,k)}function Aa(v,L,B,k){const D=v.opaque,J=v.transmissive,ae=v.transparent;h.setupLightsView(B),ie===!0&&Q.setGlobalState(y.clippingPlanes,B),k&&ye.viewport(C.copy(k)),D.length>0&&Xi(D,L,B),J.length>0&&Xi(J,L,B),ae.length>0&&Xi(ae,L,B),ye.buffers.depth.setTest(!0),ye.buffers.depth.setMask(!0),ye.buffers.color.setMask(!0),ye.setPolygonOffset(!1)}function wa(v,L,B,k){if((B.isScene===!0?B.overrideMaterial:null)!==null)return;h.state.transmissionRenderTarget[k.id]===void 0&&(h.state.transmissionRenderTarget[k.id]=new Xn(1,1,{generateMipmaps:!0,type:He.has("EXT_color_buffer_half_float")||He.has("EXT_color_buffer_float")?Vi:mn,minFilter:Vn,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ke.workingColorSpace}));const J=h.state.transmissionRenderTarget[k.id],ae=k.viewport||C;J.setSize(ae.z*y.transmissionResolutionScale,ae.w*y.transmissionResolutionScale);const de=y.getRenderTarget();y.setRenderTarget(J),y.getClearColor(W),$=y.getClearAlpha(),$<1&&y.setClearColor(16777215,.5),y.clear(),Xe&&Te.render(B);const _e=y.toneMapping;y.toneMapping=bn;const Re=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),h.setupLightsView(k),ie===!0&&Q.setGlobalState(y.clippingPlanes,k),Xi(v,B,k),E.updateMultisampleRenderTarget(J),E.updateRenderTargetMipmap(J),He.has("WEBGL_multisampled_render_to_texture")===!1){let Pe=!1;for(let Ee=0,Ye=L.length;Ee<Ye;Ee++){const $e=L[Ee],pt=$e.object,ut=$e.geometry,Ze=$e.material,be=$e.group;if(Ze.side===Wt&&pt.layers.test(k.layers)){const Mt=Ze.side;Ze.side=Lt,Ze.needsUpdate=!0,Ra(pt,B,k,ut,Ze,be),Ze.side=Mt,Ze.needsUpdate=!0,Pe=!0}}Pe===!0&&(E.updateMultisampleRenderTarget(J),E.updateRenderTargetMipmap(J))}y.setRenderTarget(de),y.setClearColor(W,$),Re!==void 0&&(k.viewport=Re),y.toneMapping=_e}function Xi(v,L,B){const k=L.isScene===!0?L.overrideMaterial:null;for(let D=0,J=v.length;D<J;D++){const ae=v[D],de=ae.object,_e=ae.geometry,Re=k===null?ae.material:k,Pe=ae.group;de.layers.test(B.layers)&&Ra(de,L,B,_e,Re,Pe)}}function Ra(v,L,B,k,D,J){v.onBeforeRender(y,L,B,k,D,J),v.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse,v.matrixWorld),v.normalMatrix.getNormalMatrix(v.modelViewMatrix),D.onBeforeRender(y,L,B,k,v,J),D.transparent===!0&&D.side===Wt&&D.forceSinglePass===!1?(D.side=Lt,D.needsUpdate=!0,y.renderBufferDirect(B,L,k,D,v,J),D.side=An,D.needsUpdate=!0,y.renderBufferDirect(B,L,k,D,v,J),D.side=Wt):y.renderBufferDirect(B,L,k,D,v,J),v.onAfterRender(y,L,B,k,D,J)}function qi(v,L,B){L.isScene!==!0&&(L=lt);const k=Me.get(v),D=h.state.lights,J=h.state.shadowsArray,ae=D.state.version,de=xe.getParameters(v,D.state,J,L,B),_e=xe.getProgramCacheKey(de);let Re=k.programs;k.environment=v.isMeshStandardMaterial?L.environment:null,k.fog=L.fog,k.envMap=(v.isMeshStandardMaterial?O:g).get(v.envMap||k.environment),k.envMapRotation=k.environment!==null&&v.envMap===null?L.environmentRotation:v.envMapRotation,Re===void 0&&(v.addEventListener("dispose",De),Re=new Map,k.programs=Re);let Pe=Re.get(_e);if(Pe!==void 0){if(k.currentProgram===Pe&&k.lightsStateVersion===ae)return Pa(v,de),Pe}else de.uniforms=xe.getUniforms(v),v.onBeforeCompile(de,y),Pe=xe.acquireProgram(de,_e),Re.set(_e,Pe),k.uniforms=de.uniforms;const Ee=k.uniforms;return(!v.isShaderMaterial&&!v.isRawShaderMaterial||v.clipping===!0)&&(Ee.clippingPlanes=Q.uniform),Pa(v,de),k.needsLights=Cl(v),k.lightsStateVersion=ae,k.needsLights&&(Ee.ambientLightColor.value=D.state.ambient,Ee.lightProbe.value=D.state.probe,Ee.directionalLights.value=D.state.directional,Ee.directionalLightShadows.value=D.state.directionalShadow,Ee.spotLights.value=D.state.spot,Ee.spotLightShadows.value=D.state.spotShadow,Ee.rectAreaLights.value=D.state.rectArea,Ee.ltc_1.value=D.state.rectAreaLTC1,Ee.ltc_2.value=D.state.rectAreaLTC2,Ee.pointLights.value=D.state.point,Ee.pointLightShadows.value=D.state.pointShadow,Ee.hemisphereLights.value=D.state.hemi,Ee.directionalShadowMap.value=D.state.directionalShadowMap,Ee.directionalShadowMatrix.value=D.state.directionalShadowMatrix,Ee.spotShadowMap.value=D.state.spotShadowMap,Ee.spotLightMatrix.value=D.state.spotLightMatrix,Ee.spotLightMap.value=D.state.spotLightMap,Ee.pointShadowMap.value=D.state.pointShadowMap,Ee.pointShadowMatrix.value=D.state.pointShadowMatrix),k.currentProgram=Pe,k.uniformsList=null,Pe}function Ca(v){if(v.uniformsList===null){const L=v.currentProgram.getUniforms();v.uniformsList=wr.seqWithValue(L.seq,v.uniforms)}return v.uniformsList}function Pa(v,L){const B=Me.get(v);B.outputColorSpace=L.outputColorSpace,B.batching=L.batching,B.batchingColor=L.batchingColor,B.instancing=L.instancing,B.instancingColor=L.instancingColor,B.instancingMorph=L.instancingMorph,B.skinning=L.skinning,B.morphTargets=L.morphTargets,B.morphNormals=L.morphNormals,B.morphColors=L.morphColors,B.morphTargetsCount=L.morphTargetsCount,B.numClippingPlanes=L.numClippingPlanes,B.numIntersection=L.numClipIntersection,B.vertexAlphas=L.vertexAlphas,B.vertexTangents=L.vertexTangents,B.toneMapping=L.toneMapping}function wl(v,L,B,k,D){L.isScene!==!0&&(L=lt),E.resetTextureUnits();const J=L.fog,ae=k.isMeshStandardMaterial?L.environment:null,de=N===null?y.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:bi,_e=(k.isMeshStandardMaterial?O:g).get(k.envMap||ae),Re=k.vertexColors===!0&&!!B.attributes.color&&B.attributes.color.itemSize===4,Pe=!!B.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),Ee=!!B.morphAttributes.position,Ye=!!B.morphAttributes.normal,$e=!!B.morphAttributes.color;let pt=bn;k.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(pt=y.toneMapping);const ut=B.morphAttributes.position||B.morphAttributes.normal||B.morphAttributes.color,Ze=ut!==void 0?ut.length:0,be=Me.get(k),Mt=h.state.lights;if(ie===!0&&(ve===!0||v!==x)){const At=v===x&&k.id===S;Q.setState(k,v,At)}let je=!1;k.version===be.__version?(be.needsLights&&be.lightsStateVersion!==Mt.state.version||be.outputColorSpace!==de||D.isBatchedMesh&&be.batching===!1||!D.isBatchedMesh&&be.batching===!0||D.isBatchedMesh&&be.batchingColor===!0&&D.colorTexture===null||D.isBatchedMesh&&be.batchingColor===!1&&D.colorTexture!==null||D.isInstancedMesh&&be.instancing===!1||!D.isInstancedMesh&&be.instancing===!0||D.isSkinnedMesh&&be.skinning===!1||!D.isSkinnedMesh&&be.skinning===!0||D.isInstancedMesh&&be.instancingColor===!0&&D.instanceColor===null||D.isInstancedMesh&&be.instancingColor===!1&&D.instanceColor!==null||D.isInstancedMesh&&be.instancingMorph===!0&&D.morphTexture===null||D.isInstancedMesh&&be.instancingMorph===!1&&D.morphTexture!==null||be.envMap!==_e||k.fog===!0&&be.fog!==J||be.numClippingPlanes!==void 0&&(be.numClippingPlanes!==Q.numPlanes||be.numIntersection!==Q.numIntersection)||be.vertexAlphas!==Re||be.vertexTangents!==Pe||be.morphTargets!==Ee||be.morphNormals!==Ye||be.morphColors!==$e||be.toneMapping!==pt||be.morphTargetsCount!==Ze)&&(je=!0):(je=!0,be.__version=k.version);let Yt=be.currentProgram;je===!0&&(Yt=qi(k,L,D));let Zn=!1,Ut=!1,Ri=!1;const ot=Yt.getUniforms(),zt=be.uniforms;if(ye.useProgram(Yt.program)&&(Zn=!0,Ut=!0,Ri=!0),k.id!==S&&(S=k.id,Ut=!0),Zn||x!==v){ye.buffers.depth.getReversed()?(le.copy(v.projectionMatrix),bc(le),Tc(le),ot.setValue(w,"projectionMatrix",le)):ot.setValue(w,"projectionMatrix",v.projectionMatrix),ot.setValue(w,"viewMatrix",v.matrixWorldInverse);const Pt=ot.map.cameraPosition;Pt!==void 0&&Pt.setValue(w,Ce.setFromMatrixPosition(v.matrixWorld)),Ve.logarithmicDepthBuffer&&ot.setValue(w,"logDepthBufFC",2/(Math.log(v.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&ot.setValue(w,"isOrthographic",v.isOrthographicCamera===!0),x!==v&&(x=v,Ut=!0,Ri=!0)}if(D.isSkinnedMesh){ot.setOptional(w,D,"bindMatrix"),ot.setOptional(w,D,"bindMatrixInverse");const At=D.skeleton;At&&(At.boneTexture===null&&At.computeBoneTexture(),ot.setValue(w,"boneTexture",At.boneTexture,E))}D.isBatchedMesh&&(ot.setOptional(w,D,"batchingTexture"),ot.setValue(w,"batchingTexture",D._matricesTexture,E),ot.setOptional(w,D,"batchingIdTexture"),ot.setValue(w,"batchingIdTexture",D._indirectTexture,E),ot.setOptional(w,D,"batchingColorTexture"),D._colorsTexture!==null&&ot.setValue(w,"batchingColorTexture",D._colorsTexture,E));const Gt=B.morphAttributes;if((Gt.position!==void 0||Gt.normal!==void 0||Gt.color!==void 0)&&we.update(D,B,Yt),(Ut||be.receiveShadow!==D.receiveShadow)&&(be.receiveShadow=D.receiveShadow,ot.setValue(w,"receiveShadow",D.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(zt.envMap.value=_e,zt.flipEnvMap.value=_e.isCubeTexture&&_e.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&L.environment!==null&&(zt.envMapIntensity.value=L.environmentIntensity),Ut&&(ot.setValue(w,"toneMappingExposure",y.toneMappingExposure),be.needsLights&&Rl(zt,Ri),J&&k.fog===!0&&ce.refreshFogUniforms(zt,J),ce.refreshMaterialUniforms(zt,k,V,te,h.state.transmissionRenderTarget[v.id]),wr.upload(w,Ca(be),zt,E)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(wr.upload(w,Ca(be),zt,E),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&ot.setValue(w,"center",D.center),ot.setValue(w,"modelViewMatrix",D.modelViewMatrix),ot.setValue(w,"normalMatrix",D.normalMatrix),ot.setValue(w,"modelMatrix",D.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const At=k.uniformsGroups;for(let Pt=0,Or=At.length;Pt<Or;Pt++){const Pn=At[Pt];P.update(Pn,Yt),P.bind(Pn,Yt)}}return Yt}function Rl(v,L){v.ambientLightColor.needsUpdate=L,v.lightProbe.needsUpdate=L,v.directionalLights.needsUpdate=L,v.directionalLightShadows.needsUpdate=L,v.pointLights.needsUpdate=L,v.pointLightShadows.needsUpdate=L,v.spotLights.needsUpdate=L,v.spotLightShadows.needsUpdate=L,v.rectAreaLights.needsUpdate=L,v.hemisphereLights.needsUpdate=L}function Cl(v){return v.isMeshLambertMaterial||v.isMeshToonMaterial||v.isMeshPhongMaterial||v.isMeshStandardMaterial||v.isShadowMaterial||v.isShaderMaterial&&v.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(v,L,B){Me.get(v.texture).__webglTexture=L,Me.get(v.depthTexture).__webglTexture=B;const k=Me.get(v);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=B===void 0,k.__autoAllocateDepthBuffer||He.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(v,L){const B=Me.get(v);B.__webglFramebuffer=L,B.__useDefaultFramebuffer=L===void 0};const Pl=w.createFramebuffer();this.setRenderTarget=function(v,L=0,B=0){N=v,A=L,R=B;let k=!0,D=null,J=!1,ae=!1;if(v){const _e=Me.get(v);if(_e.__useDefaultFramebuffer!==void 0)ye.bindFramebuffer(w.FRAMEBUFFER,null),k=!1;else if(_e.__webglFramebuffer===void 0)E.setupRenderTarget(v);else if(_e.__hasExternalTextures)E.rebindTextures(v,Me.get(v.texture).__webglTexture,Me.get(v.depthTexture).__webglTexture);else if(v.depthBuffer){const Ee=v.depthTexture;if(_e.__boundDepthTexture!==Ee){if(Ee!==null&&Me.has(Ee)&&(v.width!==Ee.image.width||v.height!==Ee.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");E.setupDepthRenderbuffer(v)}}const Re=v.texture;(Re.isData3DTexture||Re.isDataArrayTexture||Re.isCompressedArrayTexture)&&(ae=!0);const Pe=Me.get(v).__webglFramebuffer;v.isWebGLCubeRenderTarget?(Array.isArray(Pe[L])?D=Pe[L][B]:D=Pe[L],J=!0):v.samples>0&&E.useMultisampledRTT(v)===!1?D=Me.get(v).__webglMultisampledFramebuffer:Array.isArray(Pe)?D=Pe[B]:D=Pe,C.copy(v.viewport),G.copy(v.scissor),z=v.scissorTest}else C.copy(Se).multiplyScalar(V).floor(),G.copy(ke).multiplyScalar(V).floor(),z=rt;if(B!==0&&(D=Pl),ye.bindFramebuffer(w.FRAMEBUFFER,D)&&k&&ye.drawBuffers(v,D),ye.viewport(C),ye.scissor(G),ye.setScissorTest(z),J){const _e=Me.get(v.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_CUBE_MAP_POSITIVE_X+L,_e.__webglTexture,B)}else if(ae){const _e=Me.get(v.texture),Re=L;w.framebufferTextureLayer(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,_e.__webglTexture,B,Re)}else if(v!==null&&B!==0){const _e=Me.get(v.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,_e.__webglTexture,B)}S=-1},this.readRenderTargetPixels=function(v,L,B,k,D,J,ae){if(!(v&&v.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let de=Me.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ae!==void 0&&(de=de[ae]),de){ye.bindFramebuffer(w.FRAMEBUFFER,de);try{const _e=v.texture,Re=_e.format,Pe=_e.type;if(!Ve.textureFormatReadable(Re)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ve.textureTypeReadable(Pe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}L>=0&&L<=v.width-k&&B>=0&&B<=v.height-D&&w.readPixels(L,B,k,D,Ne.convert(Re),Ne.convert(Pe),J)}finally{const _e=N!==null?Me.get(N).__webglFramebuffer:null;ye.bindFramebuffer(w.FRAMEBUFFER,_e)}}},this.readRenderTargetPixelsAsync=async function(v,L,B,k,D,J,ae){if(!(v&&v.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let de=Me.get(v).__webglFramebuffer;if(v.isWebGLCubeRenderTarget&&ae!==void 0&&(de=de[ae]),de){const _e=v.texture,Re=_e.format,Pe=_e.type;if(!Ve.textureFormatReadable(Re))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ve.textureTypeReadable(Pe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(L>=0&&L<=v.width-k&&B>=0&&B<=v.height-D){ye.bindFramebuffer(w.FRAMEBUFFER,de);const Ee=w.createBuffer();w.bindBuffer(w.PIXEL_PACK_BUFFER,Ee),w.bufferData(w.PIXEL_PACK_BUFFER,J.byteLength,w.STREAM_READ),w.readPixels(L,B,k,D,Ne.convert(Re),Ne.convert(Pe),0);const Ye=N!==null?Me.get(N).__webglFramebuffer:null;ye.bindFramebuffer(w.FRAMEBUFFER,Ye);const $e=w.fenceSync(w.SYNC_GPU_COMMANDS_COMPLETE,0);return w.flush(),await Ec(w,$e,4),w.bindBuffer(w.PIXEL_PACK_BUFFER,Ee),w.getBufferSubData(w.PIXEL_PACK_BUFFER,0,J),w.deleteBuffer(Ee),w.deleteSync($e),J}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(v,L=null,B=0){v.isTexture!==!0&&(pi("WebGLRenderer: copyFramebufferToTexture function signature has changed."),L=arguments[0]||null,v=arguments[1]);const k=Math.pow(2,-B),D=Math.floor(v.image.width*k),J=Math.floor(v.image.height*k),ae=L!==null?L.x:0,de=L!==null?L.y:0;E.setTexture2D(v,0),w.copyTexSubImage2D(w.TEXTURE_2D,B,0,0,ae,de,D,J),ye.unbindTexture()};const Ll=w.createFramebuffer(),Dl=w.createFramebuffer();this.copyTextureToTexture=function(v,L,B=null,k=null,D=0,J=null){v.isTexture!==!0&&(pi("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,v=arguments[1],L=arguments[2],J=arguments[3]||0,B=null),J===null&&(D!==0?(pi("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),J=D,D=0):J=0);let ae,de,_e,Re,Pe,Ee,Ye,$e,pt;const ut=v.isCompressedTexture?v.mipmaps[J]:v.image;if(B!==null)ae=B.max.x-B.min.x,de=B.max.y-B.min.y,_e=B.isBox3?B.max.z-B.min.z:1,Re=B.min.x,Pe=B.min.y,Ee=B.isBox3?B.min.z:0;else{const Gt=Math.pow(2,-D);ae=Math.floor(ut.width*Gt),de=Math.floor(ut.height*Gt),v.isDataArrayTexture?_e=ut.depth:v.isData3DTexture?_e=Math.floor(ut.depth*Gt):_e=1,Re=0,Pe=0,Ee=0}k!==null?(Ye=k.x,$e=k.y,pt=k.z):(Ye=0,$e=0,pt=0);const Ze=Ne.convert(L.format),be=Ne.convert(L.type);let Mt;L.isData3DTexture?(E.setTexture3D(L,0),Mt=w.TEXTURE_3D):L.isDataArrayTexture||L.isCompressedArrayTexture?(E.setTexture2DArray(L,0),Mt=w.TEXTURE_2D_ARRAY):(E.setTexture2D(L,0),Mt=w.TEXTURE_2D),w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,L.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,L.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,L.unpackAlignment);const je=w.getParameter(w.UNPACK_ROW_LENGTH),Yt=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Zn=w.getParameter(w.UNPACK_SKIP_PIXELS),Ut=w.getParameter(w.UNPACK_SKIP_ROWS),Ri=w.getParameter(w.UNPACK_SKIP_IMAGES);w.pixelStorei(w.UNPACK_ROW_LENGTH,ut.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,ut.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Re),w.pixelStorei(w.UNPACK_SKIP_ROWS,Pe),w.pixelStorei(w.UNPACK_SKIP_IMAGES,Ee);const ot=v.isDataArrayTexture||v.isData3DTexture,zt=L.isDataArrayTexture||L.isData3DTexture;if(v.isDepthTexture){const Gt=Me.get(v),At=Me.get(L),Pt=Me.get(Gt.__renderTarget),Or=Me.get(At.__renderTarget);ye.bindFramebuffer(w.READ_FRAMEBUFFER,Pt.__webglFramebuffer),ye.bindFramebuffer(w.DRAW_FRAMEBUFFER,Or.__webglFramebuffer);for(let Pn=0;Pn<_e;Pn++)ot&&(w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,Me.get(v).__webglTexture,D,Ee+Pn),w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,Me.get(L).__webglTexture,J,pt+Pn)),w.blitFramebuffer(Re,Pe,ae,de,Ye,$e,ae,de,w.DEPTH_BUFFER_BIT,w.NEAREST);ye.bindFramebuffer(w.READ_FRAMEBUFFER,null),ye.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else if(D!==0||v.isRenderTargetTexture||Me.has(v)){const Gt=Me.get(v),At=Me.get(L);ye.bindFramebuffer(w.READ_FRAMEBUFFER,Ll),ye.bindFramebuffer(w.DRAW_FRAMEBUFFER,Dl);for(let Pt=0;Pt<_e;Pt++)ot?w.framebufferTextureLayer(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,Gt.__webglTexture,D,Ee+Pt):w.framebufferTexture2D(w.READ_FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,Gt.__webglTexture,D),zt?w.framebufferTextureLayer(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,At.__webglTexture,J,pt+Pt):w.framebufferTexture2D(w.DRAW_FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_2D,At.__webglTexture,J),D!==0?w.blitFramebuffer(Re,Pe,ae,de,Ye,$e,ae,de,w.COLOR_BUFFER_BIT,w.NEAREST):zt?w.copyTexSubImage3D(Mt,J,Ye,$e,pt+Pt,Re,Pe,ae,de):w.copyTexSubImage2D(Mt,J,Ye,$e,Re,Pe,ae,de);ye.bindFramebuffer(w.READ_FRAMEBUFFER,null),ye.bindFramebuffer(w.DRAW_FRAMEBUFFER,null)}else zt?v.isDataTexture||v.isData3DTexture?w.texSubImage3D(Mt,J,Ye,$e,pt,ae,de,_e,Ze,be,ut.data):L.isCompressedArrayTexture?w.compressedTexSubImage3D(Mt,J,Ye,$e,pt,ae,de,_e,Ze,ut.data):w.texSubImage3D(Mt,J,Ye,$e,pt,ae,de,_e,Ze,be,ut):v.isDataTexture?w.texSubImage2D(w.TEXTURE_2D,J,Ye,$e,ae,de,Ze,be,ut.data):v.isCompressedTexture?w.compressedTexSubImage2D(w.TEXTURE_2D,J,Ye,$e,ut.width,ut.height,Ze,ut.data):w.texSubImage2D(w.TEXTURE_2D,J,Ye,$e,ae,de,Ze,be,ut);w.pixelStorei(w.UNPACK_ROW_LENGTH,je),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,Yt),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Zn),w.pixelStorei(w.UNPACK_SKIP_ROWS,Ut),w.pixelStorei(w.UNPACK_SKIP_IMAGES,Ri),J===0&&L.generateMipmaps&&w.generateMipmap(Mt),ye.unbindTexture()},this.copyTextureToTexture3D=function(v,L,B=null,k=null,D=0){return v.isTexture!==!0&&(pi("WebGLRenderer: copyTextureToTexture3D function signature has changed."),B=arguments[0]||null,k=arguments[1]||null,v=arguments[2],L=arguments[3],D=arguments[4]||0),pi('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(v,L,B,k,D)},this.initRenderTarget=function(v){Me.get(v).__webglFramebuffer===void 0&&E.setupRenderTarget(v)},this.initTexture=function(v){v.isCubeTexture?E.setTextureCube(v,0):v.isData3DTexture?E.setTexture3D(v,0):v.isDataArrayTexture||v.isCompressedArrayTexture?E.setTexture2DArray(v,0):E.setTexture2D(v,0),ye.unbindTexture()},this.resetState=function(){A=0,R=0,N=null,ye.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return an}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorspace=Ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=Ke._getUnpackColorSpace()}}function Zp(i,e=!1){const t=i[0].index!==null,n=new Set(Object.keys(i[0].attributes)),r=new Set(Object.keys(i[0].morphAttributes)),s={},o={},a=i[0].morphTargetsRelative,l=new Bt;let c=0;for(let u=0;u<i.length;++u){const d=i[u];let f=0;if(t!==(d.index!==null))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them."),null;for(const p in d.attributes){if(!n.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+'. All geometries must have compatible attributes; make sure "'+p+'" attribute exists among all geometries, or in none of them.'),null;s[p]===void 0&&(s[p]=[]),s[p].push(d.attributes[p]),f++}if(f!==n.size)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". Make sure all geometries have the same number of attributes."),null;if(a!==d.morphTargetsRelative)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". .morphTargetsRelative must be consistent throughout all geometries."),null;for(const p in d.morphAttributes){if(!r.has(p))return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+".  .morphAttributes must be consistent throughout all geometries."),null;o[p]===void 0&&(o[p]=[]),o[p].push(d.morphAttributes[p])}if(e){let p;if(t)p=d.index.count;else if(d.attributes.position!==void 0)p=d.attributes.position.count;else return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index "+u+". The geometry must have either an index or a position attribute"),null;l.addGroup(c,p,u),c+=p}}if(t){let u=0;const d=[];for(let f=0;f<i.length;++f){const p=i[f].index;for(let _=0;_<p.count;++_)d.push(p.getX(_)+u);u+=i[f].attributes.position.count}l.setIndex(d)}for(const u in s){const d=Ho(s[u]);if(!d)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" attribute."),null;l.setAttribute(u,d)}for(const u in o){const d=o[u][0].length;if(d===0)break;l.morphAttributes=l.morphAttributes||{},l.morphAttributes[u]=[];for(let f=0;f<d;++f){const p=[];for(let M=0;M<o[u].length;++M)p.push(o[u][M][f]);const _=Ho(p);if(!_)return console.error("THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the "+u+" morphAttribute."),null;l.morphAttributes[u].push(_)}}return l}function Ho(i){let e,t,n,r=-1,s=0;for(let c=0;c<i.length;++c){const u=i[c];if(e===void 0&&(e=u.array.constructor),e!==u.array.constructor)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes."),null;if(t===void 0&&(t=u.itemSize),t!==u.itemSize)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes."),null;if(n===void 0&&(n=u.normalized),n!==u.normalized)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes."),null;if(r===-1&&(r=u.gpuType),r!==u.gpuType)return console.error("THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes."),null;s+=u.count*t}const o=new e(s),a=new Ot(o,t,n);let l=0;for(let c=0;c<i.length;++c){const u=i[c];if(u.isInterleavedBufferAttribute){const d=l/t;for(let f=0,p=u.count;f<p;f++)for(let _=0;_<t;_++){const M=u.getComponent(f,_);a.setComponent(f+d,_,M)}}else o.set(u.array,l);l+=u.count*t}return r!==void 0&&(a.gpuType=r),a}const Kp=new ou,Qe=new Dt(1,1,1),$p=new Dt(.85,1,.85),jp=new Dt(.12,.7,.12),Vo=new Dt(1,.5,1),Jp=new Dt(1,1,.125),Tl=new Dt(1,.5,1),Al=new Dt(1,.5,.5);Al.translate(0,.25,-.25);Tl.translate(0,-.25,0);const Wo=Zp([Tl,Al]);function Le(i){const e=Kp.load(i);return e.colorSpace=Ft,e.magFilter=Ct,e.minFilter=Ct,e.generateMipmaps=!0,e.minFilter=uc,e}const ne={dirt:Le("images/dirt.png"),grass:Le("images/grass.png"),grassSide:Le("images/grass_block_side.png"),stone:Le("images/stone.png"),cobblestone:Le("images/cobblestone.png"),bedrock:Le("images/bedrock.png"),coalOre:Le("images/coal_ore.png"),ironOre:Le("images/iron_ore.png"),goldOre:Le("images/gold_ore.png"),redstoneOre:Le("images/redstone_ore.png"),crafting_table_top:Le("images/crafting_table_top.png"),crafting_table_front:Le("images/crafting_table_front.png"),crafting_table_side:Le("images/crafting_table_side.png"),planks:Le("images/planks_oak.png"),log_top:Le("images/log_oak_top.png"),log:Le("images/log_oak.png"),leaves:Le("images/leaves.png"),glass:Le("images/glass.png"),furnace_top:Le("images/furnace_top.png"),furnace_side:Le("images/furnace_side.png"),furnace_front:Le("images/furnace_front_off.png"),chest_top:Le("images/chest_top.png"),chest_side:Le("images/chest_side.png"),chest_front:Le("images/chest_front.png"),sand:Le("images/sand.png"),gravel:Le("images/gravel.png"),torch:Le("images/torch.png"),torch_top:Le("images/torch_top.png"),diamondOre:Le("images/diamond_ore.png"),cactus_side:Le("images/cactus_side.png"),cactus_top:Le("images/cactus_top.png"),sandstone_top:Le("images/sandstone_top.png"),sandstone_side:Le("images/sandstone_side.png"),sandstone_bottom:Le("images/sandstone_bottom.png"),oak_door_bottom:Le("images/oak_door_bottom.png"),oak_door_top:Le("images/oak_door_top.png"),fence:Le("images/fence_oak.png"),obsidian:Le("images/obsidian.png"),ice:Le("images/ice.png"),redstone_lamp_off:Le("images/redstone_lamp.png"),redstone_lamp_on:Le("images/redstone_lamp_on.png"),ladder:Le("images/ladder.png"),iron_furnace_front:Le("images/mod/iron_furnace_front_off.png"),iron_furnace_side:Le("images/mod/iron_furnace_top.png")},Fe={PICKAXE:"pickaxe",AXE:"axe",SHOVEL:"shovel",HAND:"hand"},en={WOOD:2,STONE:4,IRON:6,GOLD:12,DIAMOND:8,NETHERITE:9},F={empty:{id:0,name:"empty",visible:!1},grass:{id:1,name:"grass",type:"block",stackable:!0,hardness:.6,material:[new ee({map:ne.grassSide}),new ee({map:ne.grassSide}),new ee({map:ne.grass}),new ee({map:ne.dirt}),new ee({map:ne.grassSide}),new ee({map:ne.grassSide})],icon:"images/block-icon/grass.png",tool:Fe.SHOVEL,need_tool:!1,geometry:Qe,soundGroup:"grass"},dirt:{id:2,name:"dirt",type:"block",stackable:!0,hardness:.5,material:new ee({map:ne.dirt}),icon:"images/block-icon/dirt.webp",tool:Fe.SHOVEL,need_tool:!1,geometry:Qe,soundGroup:"grass"},stone:{id:3,name:"Stone",type:"block",stackable:!0,hardness:1.5,material:new ee({map:ne.stone}),icon:"images/block-icon/stone.png",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,drops:4,soundGroup:"stone"},cobblestone:{id:4,name:"Cobblestone",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.cobblestone}),icon:"images/block-icon/cobblestone.webp",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,soundGroup:"stone"},planks:{id:6,name:"planks",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.planks}),icon:"images/block-icon/wood.png",tool:Fe.AXE,geometry:Qe,soundGroup:"wood"},bedrock:{id:7,name:"bedrock",type:"block",stackable:!0,hardness:1e4,material:new ee({map:ne.bedrock}),geometry:Qe},water:{id:9,name:"water",type:"block",stackable:!0,hardness:1e4,material:[new zn({transparent:!0,opacity:0}),new zn({transparent:!0,opacity:0}),new ee(new ee({color:9474272,transparent:!0,opacity:.5,side:Wt})),new zn({transparent:!0,opacity:0}),new zn({transparent:!0,opacity:0}),new zn({transparent:!0,opacity:0})],transparent:!0,geometry:Qe},lava:{id:11,name:"lava",type:"block",stackable:!0,hardness:1e4,material:new ee(new ee({color:16284937,transparent:!0,opacity:.5,side:Wt})),transparent:!0,geometry:Qe},sand:{id:12,name:"sand",type:"block",stackable:!0,hardness:.5,material:new ee({map:ne.sand}),icon:"images/block-icon/sand.webp",tool:Fe.SHOVEL,geometry:Qe,soundGroup:"sand"},gravel:{id:13,name:"gravel",type:"block",stackable:!0,hardness:.6,material:new ee({map:ne.gravel}),icon:"images/block-icon/gravel.webp",tool:Fe.SHOVEL,geometry:Qe,soundGroup:"gravel"},goldOre:{id:14,name:"gold_ore",type:"block",stackable:!0,hardness:3,material:new ee({map:ne.goldOre}),scale:{x:40,y:40,z:40},scarcity:.91,icon:"images/block-icon/gold_ore.webp",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,soundGroup:"stone"},ironOre:{id:15,name:"iron_ore",type:"block",stackable:!0,hardness:3,material:new ee({map:ne.ironOre}),scale:{x:40,y:40,z:40},scarcity:.9,icon:"images/block-icon/iron_ore.png",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,soundGroup:"stone"},coalOre:{id:16,name:"coal_ore",type:"block",stackable:!0,hardness:3,material:new ee({map:ne.coalOre}),scale:{x:20,y:20,z:20},scarcity:.8,icon:"images/block-icon/coal_ore.png",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,drops:302,soundGroup:"stone"},log:{id:17,name:"log",type:"block",stackable:!0,hardness:2,material:[new ee({map:ne.log}),new ee({map:ne.log}),new ee({map:ne.log_top}),new ee({map:ne.log_top}),new ee({map:ne.log}),new ee({map:ne.log})],icon:"images/block-icon/log.png",tool:Fe.AXE,geometry:Qe,soundGroup:"wood"},leaves:{id:18,name:"leaves",type:"block",stackable:!0,hardness:.2,material:new ee({map:ne.leaves}),icon:"images/block-icon/leaves.webp",geometry:Qe,soundGroup:"grass"},glass:{id:20,name:"glass",type:"block",stackable:!0,hardness:.3,material:new ee({map:ne.glass,transparent:!0}),transparent:!1,icon:"images/block-icon/glass.webp",geometry:Qe,soundGroup:"glass"},sandstone:{id:24,name:"sandstone",type:"block",stackable:!0,hardness:.8,material:[new ee({map:ne.sandstone_side}),new ee({map:ne.sandstone_side}),new ee({map:ne.sandstone_top}),new ee({map:ne.sandstone_bottom}),new ee({map:ne.sandstone_side}),new ee({map:ne.sandstone_side})],transparent:!1,icon:"images/block-icon/sandstone.webp",tool:Fe.PICKAXE,geometry:Qe,soundGroup:"stone"},smooth_stone_slab:{id:44,name:"Smooth Stone Slab",type:"block",stackable:!0,hardness:6,material:new ee({map:ne.planks}),icon:"images/block-icon/smooth_stone_slab.png",tool:Fe.AXE,geometry:Vo,transparent:!0,soundGroup:"stone"},obsidian:{id:49,name:"obsidian",type:"block",stackable:!0,hardness:50,material:new ee({map:ne.obsidian}),transparent:!1,icon:"images/block-icon/obsidian.webp",tool:Fe.PICKAXE,geometry:Qe,soundGroup:"stone"},torch:{id:50,name:"torch",type:"block",stackable:!0,hardness:0,material:[new ee({map:ne.torch}),new ee({map:ne.torch}),new ee({map:ne.torch_top}),new ee({map:ne.torch}),new ee({map:ne.torch}),new ee({map:ne.torch})],transparent:!0,icon:"images/block-icon/torch.webp",geometry:jp,soundGroup:"wood"},oak_stairs:{id:53,name:"oak_stairs",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.planks}),transparent:!0,icon:"images/block-icon/oak_stairs.png",tool:Fe.AXE,geometry:Wo,soundGroup:"wood"},chest:{id:54,name:"chest",type:"block",stackable:!0,hardness:2.5,material:[new ee({map:ne.chest_side}),new ee({map:ne.chest_side}),new ee({map:ne.chest_top}),new ee({map:ne.chest_side}),new ee({map:ne.chest_front}),new ee({map:ne.chest_side})],icon:"images/block-icon/chest.webp",interface:!0,tool:Fe.AXE,geometry:Qe,soundGroup:"wood"},diamondOre:{id:56,name:"diamond_ore",type:"block",stackable:!0,hardness:3,material:new ee({map:ne.diamondOre}),scale:{x:40,y:40,z:40},scarcity:.99,icon:"images/block-icon/diamond_ore.png",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,drops:304,soundGroup:"stone"},craftingTable:{id:58,name:"Crafting Table",type:"block",stackable:!0,hardness:2.5,material:[new ee({map:ne.crafting_table_side}),new ee({map:ne.crafting_table_side}),new ee({map:ne.crafting_table_top}),new ee({map:ne.crafting_table_side}),new ee({map:ne.crafting_table_front}),new ee({map:ne.crafting_table_side})],icon:"images/block-icon/crafting_table.webp",interface:!0,tool:Fe.AXE,geometry:Qe,soundGroup:"wood"},furnace:{id:61,name:"Furnace",type:"block",stackable:!0,hardness:3.5,material:[new ee({map:ne.furnace_side}),new ee({map:ne.furnace_side}),new ee({map:ne.furnace_top}),new ee({map:ne.furnace_side}),new ee({map:ne.furnace_front}),new ee({map:ne.furnace_side})],icon:"images/block-icon/furnace.webp",interface:!0,tool:Fe.PICKAXE,geometry:Qe,soundGroup:"stone"},oak_door:{id:64,name:"oak_door",type:"item",stackable:!1,hardness:1,icon:"images/block-icon/oak_door.png",material:new ee({map:ne.oak_door_bottom}),interactive:!0,openable:!0,transparent:!0,soundGroup:"wood",geometry:Qe},ladder:{id:65,name:"ladder",type:"block",stackable:!0,hardness:.4,material:new ee({map:ne.ladder,transparent:!0,opacity:.95,side:Wt}),icon:"images/block-icon/ladder.png",tool:Fe.AXE,geometry:Jp,transparent:!0,nonSolid:!0,climbable:!0,soundGroup:"wood"},oak_door_top:{id:1064,name:"oak_door",type:"block",stackable:!1,hardness:1,icon:"images/block-icon/oak_door.png",material:new ee({map:ne.oak_door_top}),interactive:!0,openable:!0,transparent:!0,soundGroup:"wood",geometry:Qe},cobblestone_stairs:{id:67,name:"cobblestone_stairs",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.cobblestone}),transparent:!0,icon:"images/block-icon/cobblestone_stairs.png",tool:Fe.PICKAXE,geometry:Wo,soundGroup:"stone"},lever:{id:69,name:"lever",type:"block",stackable:!0,hardness:.5,material:new ee({color:8026746}),icon:"images/block-icon/lever.png",tool:Fe.PICKAXE,geometry:new Dt(.25,.25,.25),transparent:!0,interactive:!0,toggleable:!0,emitsPower:!0,powered:!1,soundGroup:"stone"},redstoneOre:{id:73,name:"redstone_ore",type:"block",stackable:!0,hardness:3,material:new ee({map:ne.redstoneOre}),scale:{x:40,y:40,z:40},scarcity:.9,icon:"images/block-icon/restone_ore.png",tool:Fe.PICKAXE,need_tool:!0,geometry:Qe,soundGroup:"stone"},ice:{id:79,name:"ice",type:"block",stackable:!0,hardness:.5,material:new ee({map:ne.ice,transparent:!0,opacity:.95}),icon:"images/block-icon/ice.png",tool:Fe.PICKAXE,need_tool:!1,geometry:Qe,transparent:!0,friction:.02,soundGroup:"glass"},cactus:{id:81,name:"cactus",type:"block",stackable:!0,hardness:.4,material:[new ee({map:ne.cactus_side}),new ee({map:ne.cactus_side}),new ee({map:ne.cactus_top}),new ee({map:ne.cactus_top}),new ee({map:ne.cactus_side}),new ee({map:ne.cactus_side})],transparent:!0,icon:"images/block-icon/cactus.webp",tool:Fe.AXE,geometry:$p,soundGroup:"stone"},oak_fence:{id:85,name:"oak_fence",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.planks}),icon:"images/block-icon/oak_fence.webp",tool:Fe.AXE,geometry:new Dt(.3,1,.3),transparent:!0,connectable:!0,soundGroup:"wood"},redstone_lamp:{id:123,name:"Redstone Lamp",type:"block",stackable:!0,hardness:.3,material:new ee({map:ne.redstone_lamp_off}),icon:"images/block-icon/redstone_lamp.png",tool:Fe.PICKAXE,geometry:Qe,transparent:!1,toggleable:!0,receivesPower:!0,powered:!1,soundGroup:"glass"},redstone_lamp_on:{id:124,name:"Redstone Lamp (On)",type:"block",stackable:!0,hardness:.3,material:new ee({map:ne.redstone_lamp_on,emissive:16773792,emissiveIntensity:1.2}),icon:"images/block-icon/redstone_lamp.png",tool:Fe.PICKAXE,geometry:Qe,transparent:!1,toggleable:!0,receivesPower:!0,powered:!0,soundGroup:"glass"},oak_slab:{id:158,name:"oak_slab",type:"block",stackable:!0,hardness:2,material:new ee({map:ne.planks}),icon:"images/block-icon/oak_slab.png",tool:Fe.AXE,geometry:Vo,transparent:!0,soundGroup:"wood"},beef:{id:273,name:"Raw Beef",type:"item",stackable:!1,icon:"images/block-icon/beef.webp"},iron_pickaxe:{id:297,name:"Iron Pickaxe",type:"item",stackable:!1,icon:"images/block-icon/iron_pickaxe.webp",tool_type:Fe.PICKAXE,tool_material:en.IRON},iron_axe:{id:315,name:"Iron axe",type:"item",stackable:!1,icon:"images/block-icon/iron_axe.webp",tool_type:Fe.AXE,tool_material:en.IRON},coal:{id:302,name:"Coal",type:"item",stackable:!0,icon:"images/block-icon/coal.webp"},diamond:{id:304,name:"Diamond",type:"item",stackable:!0,icon:"images/block-icon/diamond.webp"},iron_ingot:{id:305,name:"Iron Ingot",type:"item",stackable:!0,icon:"images/block-icon/iron_ingot.webp"},gold_ingot:{id:306,name:"Gold Ingot",type:"item",stackable:!0,icon:"images/block-icon/gold_ingot.webp"},wooden_shovel:{id:309,name:"Wooden Shovel",type:"item",stackable:!1,icon:"images/block-icon/wooden_shovel.webp",tool_type:Fe.SHOVEL,tool_material:en.WOOD},wooden_pickaxe:{id:310,name:"Wooden Pickaxe",type:"item",stackable:!1,icon:"images/block-icon/wooden_pickaxe.png",tool_type:Fe.PICKAXE,tool_material:en.WOOD},stone_shovel:{id:313,name:"Stone Shovel",type:"item",stackable:!1,icon:"images/block-icon/stone_shovel.webp",tool_type:Fe.SHOVEL,tool_material:en.STONE},stone_pickaxe:{id:314,name:"Stone Pickaxe",type:"item",stackable:!1,icon:"images/block-icon/stone_pickaxe.webp",tool_type:Fe.PICKAXE,tool_material:en.STONE},stone_axe:{id:315,name:"Stone axe",type:"item",stackable:!1,icon:"images/block-icon/stone_axe.webp",tool_type:Fe.AXE,tool_material:en.STONE},diamond_pickaxe:{id:318,name:"Diamind Pickaxe",type:"item",stackable:!1,icon:"images/block-icon/diamond_pickaxe.webp",tool_type:Fe.PICKAXE,tool_material:en.DIAMOND},diamond_axe:{id:319,name:"Diamind Axe",type:"item",stackable:!1,icon:"images/block-icon/diamond_axe.webp",tool_type:Fe.AXE,tool_material:en.DIAMOND},stick:{id:320,name:"Stick",type:"item",stackable:!0,icon:"images/block-icon/stick.webp"},gold_pickaxe:{id:324,name:"Gold Pickaxe",type:"item",stackable:!1,icon:"images/block-icon/golden_pickaxe.png",tool_type:Fe.PICKAXE,tool_material:en.GOLD},bucket:{id:360,name:"Bucket",type:"item",stackable:!0,icon:"images/block-icon/bucket.webp"},water_bucket:{id:362,name:"Water Bucket",type:"item",stackable:!0,icon:"images/block-icon/water_bucket.webp"},oak_boat:{id:375,name:"Boat",type:"item",stackable:!1,icon:"images/block-icon/oak_boat.webp"},green_dye:{id:397,name:"Green Dye",type:"item",stackable:!0,icon:"images/block-icon/cactus_green.png"},iron_furnace:{id:1061,name:"Iron Furnace",type:"block",stackable:!0,hardness:3.5,material:[new ee({map:ne.iron_furnace_side}),new ee({map:ne.iron_furnace_side}),new ee({map:ne.iron_furnace_side}),new ee({map:ne.iron_furnace_side}),new ee({map:ne.iron_furnace_front}),new ee({map:ne.iron_furnace_side})],icon:"images/block-icon/iron_furnace.webp",interface:!0,tool:Fe.PICKAXE,geometry:Qe,soundGroup:"stone"}},Qp=Object.fromEntries(Object.values(F).map(i=>[i.id,i]));function pm(i){return Qp[i]||null}const em={15:{id:305,quantity:1},14:{id:306,quantity:1},12:{id:20,quantity:1},4:{id:3,quantity:1},81:{id:397,quantity:1}};class mm{getOutput(e){return e!=null&&e.block?em[e.block]??null:null}}const Xo={crafting_table:{pattern:[[F.planks.id,F.planks.id,null],[F.planks.id,F.planks.id,null],[null,null,null]],output:{id:F.craftingTable.id,quantity:1}},planks:{pattern:[[F.log.id,null,null],[null,null,null],[null,null,null]],output:{id:F.planks.id,quantity:4}},wooden_shovel:{pattern:[[null,F.planks.id,null],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.wooden_shovel.id,quantity:1}},wooden_pickaxe:{pattern:[[F.planks.id,F.planks.id,F.planks.id],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.wooden_pickaxe.id,quantity:1}},stone_pickaxe:{pattern:[[F.cobblestone.id,F.cobblestone.id,F.cobblestone.id],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.stone_pickaxe.id,quantity:1}},stone_shovel:{pattern:[[null,F.cobblestone.id,null],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.stone_shovel.id,quantity:1}},stone_axe:{pattern:[[F.cobblestone.id,F.cobblestone.id,null],[F.cobblestone.id,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.stone_axe.id,quantity:1}},iron_pickaxe:{pattern:[[F.iron_ingot.id,F.iron_ingot.id,F.iron_ingot.id],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.iron_pickaxe.id,quantity:1}},iron_axe:{pattern:[[F.iron_ingot.id,F.iron_ingot.id,null],[F.iron_ingot.id,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.iron_axe.id,quantity:1}},gold_pickaxe:{pattern:[[F.gold_ingot.id,F.gold_ingot.id,F.gold_ingot.id],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.gold_pickaxe.id,quantity:1}},diamond_pickaxe:{pattern:[[F.diamond.id,F.diamond.id,F.diamond.id],[null,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.diamond_pickaxe.id,quantity:1}},diamond_axe:{pattern:[[F.diamond.id,F.diamond.id,null],[F.diamond.id,F.stick.id,null],[null,F.stick.id,null]],output:{id:F.diamond_axe.id,quantity:1}},chest:{pattern:[[F.planks.id,F.planks.id,F.planks.id],[F.planks.id,null,F.planks.id],[F.planks.id,F.planks.id,F.planks.id]],output:{id:F.chest.id,quantity:1}},furnace:{pattern:[[F.cobblestone.id,F.cobblestone.id,F.cobblestone.id],[F.cobblestone.id,null,F.cobblestone.id],[F.cobblestone.id,F.cobblestone.id,F.cobblestone.id]],output:{id:F.furnace.id,quantity:1}},stick:{pattern:[[F.planks.id,null,null],[F.planks.id,null,null],[null,null,null]],output:{id:F.stick.id,quantity:4}},torch:{pattern:[[F.coal.id,null,null],[F.stick.id,null,null],[null,null,null]],output:{id:F.torch.id,quantity:4}},oak_stairs:{pattern:[[F.planks.id,null,null],[F.planks.id,F.planks.id,null],[F.planks.id,F.planks.id,F.planks.id]],output:{id:F.oak_stairs.id,quantity:6}},cobblestone_stairs:{pattern:[[F.cobblestone.id,null,null],[F.cobblestone.id,F.cobblestone.id,null],[F.cobblestone.id,F.cobblestone.id,F.cobblestone.id]],output:{id:F.cobblestone_stairs.id,quantity:6}},oak_boat:{pattern:[[null,null,null],[F.planks.id,null,F.planks.id],[F.planks.id,F.planks.id,F.planks.id]],output:{id:F.oak_boat.id,quantity:1}},oak_door:{pattern:[[F.planks.id,F.planks.id,null],[F.planks.id,F.planks.id,null],[F.planks.id,F.planks.id,null]],output:{id:F.oak_door.id,quantity:1}},oak_fence:{pattern:[[null,null,null],[F.planks.id,F.stick.id,F.planks.id],[F.planks.id,F.stick.id,F.planks.id]],output:{id:F.oak_fence.id,quantity:3}},sandstone:{pattern:[[F.sand.id,F.sand.id,null],[F.sand.id,F.sand.id,null],[null,null,null]],output:{id:F.sandstone.id,quantity:1}},bucket:{pattern:[[F.iron_ingot.id,null,F.iron_ingot.id],[null,F.iron_ingot.id,null],[null,null,null]],output:{id:F.bucket.id,quantity:1}},smooth_stone_slab:{pattern:[[null,null,null],[null,null,null],[F.stone.id,F.stone.id,F.stone.id]],output:{id:F.smooth_stone_slab.id,quantity:6}},oak_slab:{pattern:[[null,null,null],[null,null,null],[F.planks.id,F.planks.id,F.planks.id]],output:{id:F.oak_slab.id,quantity:6}},ladder:{pattern:[[F.stick.id,null,F.stick.id],[F.stick.id,F.stick.id,F.stick.id],[F.stick.id,null,F.planks.id]],output:{id:F.ladder.id,quantity:3}},iron_furnace:{pattern:[[F.iron_ingot.id,F.iron_ingot.id,F.iron_ingot.id],[F.iron_ingot.id,null,F.iron_ingot.id],[F.iron_ingot.id,F.iron_ingot.id,F.iron_ingot.id]],output:{id:F.iron_furnace.id,quantity:1}}};class gm{check(e){let t=null;return Object.values(Xo).forEach((n,r)=>{n.needed==(e==null?void 0:e.block)&&(t=n.gain)}),t}checkRecipe(e){console.log(e);for(const[t,n]of Object.entries(Xo)){let r=!0;for(let s=0;s<e.length;s++)for(let o=0;o<e[0].length;o++)if(e[s][o]!==n.pattern[s][o]){r=!1;break}if(r)return n.output}return null}}export{lm as A,Yn as B,dm as C,om as D,Qt as E,dl as F,_r as G,im as I,sm as M,Ct as N,Vt as P,Wi as Q,um as R,Ft as S,ou as T,U as V,fm as W,Dt as a,Jt as b,gl as c,zn as d,ee as e,Be as f,pm as g,F as h,et as i,mm as j,am as k,_l as l,gm as m,nm as n,Kc as o,hm as p,rm as q,tm as r,Nl as s,Ie as t,cm as u,Xo as v,em as w};
